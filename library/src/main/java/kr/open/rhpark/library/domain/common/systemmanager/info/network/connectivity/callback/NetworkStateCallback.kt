package kr.open.rhpark.library.domain.common.systemmanager.info.network.connectivity.callback
...
import kr.open.rhpark.library.domain.common.systemmanager.info.network.telephony.data.state.TelephonyNetworkDetailType
import kr.open.rhpark.library.domain.common.systemmanager.info.network.telephony.data.state.TelephonyNetworkState
import kr.open.rhpark.library.domain.common.systemmanager.info.network.telephony.data.state.TelephonyNetworkType
