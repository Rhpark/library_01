...
import kr.open.rhpark.library.domain.common.systemmanager.info.network.telephony.data.cell.cdma.CellIdentityCdmaData
import kr.open.rhpark.library.domain.common.systemmanager.info.network.telephony.data.cell.gsm.CellIdentityGsmData
import kr.open.rhpark.library.domain.common.systemmanager.info.network.telephony.data.cell.lte.CellIdentityLteData
import kr.open.rhpark.library.domain.common.systemmanager.info.network.telephony.data.cell.nr.CellIdentityNrData
import kr.open.rhpark.library.domain.common.systemmanager.info.network.telephony.data.cell.tdscdma.CellIdentityTdscdmaData
import kr.open.rhpark.library.domain.common.systemmanager.info.network.telephony.data.cell.wcdma.CellIdentityWcdmaData
